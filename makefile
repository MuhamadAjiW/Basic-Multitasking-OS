...
SRC := $(filter-out $(SOURCE_FOLDER)/user/%, $(filter-out $(SOURCE_FOLDER)/chuuloop/%, $(shell find $(SOURCE_FOLDER) -name '*.c')))
DIR := $(filter-out $(SOURCE_FOLDER), $(filter-out $(SOURCE_FOLDER)/user, $(filter-out $(SOURCE_FOLDER)/chuuloop, $(patsubst $(SOURCE_FOLDER)/%, $(OUTPUT_FOLDER)/%, $(shell find $(SOURCE_FOLDER) -type d)))))

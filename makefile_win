...
shell: dir-u $(OBJ_U)
	...
	@$(LIN) -T $(SOURCE_FOLDER)/shell/shell-linker.ld -m elf_i386 \
		shell-entry.o $(OBJ_U) -o $(OUTPUT_FOLDER)/sh
	
	@echo Linking object shell object files and generate ELF32 for debugging...
	@$(LIN) -T $(SOURCE_FOLDER)/shell/shell-linker.ld -m elf_i386 --oformat=elf32-i386\
...
clock: dir-c $(OBJ_C)
	...
	@echo Linking object shell object files and generate flat binary...
	@$(LIN) -T $(SOURCE_FOLDER)/clock/shell-linker.ld -m elf_i386 \
		shell-entry.o $(OBJ_C) -o $(OUTPUT_FOLDER)/sysclock
	
	@echo Linking object clock object files and generate ELF32 for debugging...
	@$(LIN) -T $(SOURCE_FOLDER)/clock/shell-linker.ld -m elf_i386 --oformat=elf32-i386\
...
bouncy: dir-b $(OBJ_B)
	...
	@echo Linking object shell object files and generate flat binary...
	@$(LIN) -T $(SOURCE_FOLDER)/bouncy/shell-linker.ld -m elf_i386 \
		shell-entry.o $(OBJ_B) -o $(OUTPUT_FOLDER)/bounce
	
	@echo Linking object bouncy object files and generate ELF32 for debugging...
	@$(LIN) -T $(SOURCE_FOLDER)/bouncy/shell-linker.ld -m elf_i386 --oformat=elf32-i386\
...
# 	@echo Turning possibly dos files into unix files... && cd other && dos2unix stdfont && dos2unix stdbg && dos2unix stdbg2 && dos2unix stdanim && dos2unix text
	...
	@echo Inserting first background image into system directory... && cp other/stdbg1 bin/stdbg1 && cd bin && ./inserter stdbg1 67 drive.img imp
	@echo Inserting second background image into system directory... && cp other/stdbg2 bin/stdbg2 && cd bin && ./inserter stdbg2 67 drive.img imp
	@echo Inserting third background image into system directory... && cp other/stdbg3 bin/stdbg3 && cd bin && ./inserter stdbg3 67 drive.img imp
	@echo Inserting fourth background image into system directory... && cp other/stdbg4 bin/stdbg4 && cd bin && ./inserter stdbg4 67 drive.img imp
	@echo Inserting fifth background image into system directory... && cp other/stdbg5 bin/stdbg5 && cd bin && ./inserter stdbg5 67 drive.img imp

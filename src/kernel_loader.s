...
global set_tss_register_kernel                ; set tss register to GDT entry
global set_tss_register_user                ; set tss register to GDT entry
...
set_tss_register_kernel:
    mov ax, 0x28   ; GDT TSS Selector, ring 0
    ltr ax
    ret

set_tss_register_user:
    mov ax, 0x30   ; GDT TSS Selector, ring 3
    ltr ax
    ret
